...
export default function Home() {
  ...
  return <main>
    <header className="site-header">
      <a className="brand" href="#ana-sayfa" aria-label="Kamu Sosyal Tesisleri ana sayfa"><img className="brand-logo" src="/kamu-sosyal-tesisleri-logo.png" alt="Kamu Sosyal Tesisleri logosu" width="58" height="58" style={{ width: 58, height: 58, objectFit: "contain" }} /></a>
    ...
    <style>{`.site-footer .brand{display:block;width:72px;height:72px;background:url('/kamu-sosyal-tesisleri-logo.png') center/contain no-repeat}.site-footer .brand>*{display:none}`}</style>
  </main>;
}
