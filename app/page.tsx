...
const priceList = [
  ["Orduevleri", "140 TL – 1.405 TL", "190 TL – 1.400 TL"],
  ["Askerî gazino / misafirhane", "70 TL – 410 TL", "Yalnızca görevli personel"],
  ["Polisevleri", "848 TL – 1.550 TL", "1.317 TL – 2.200 TL"],
  ["Öğretmenevleri", "750 TL – 1.600 TL", "1.500 TL – 2.650 TL"],
  ["Hekimevleri", "650 TL – 900 TL", "900 TL – 1.400 TL"],
  ["Uygulama otelleri", "1.000 TL – 1.800 TL", "1.500 TL – 2.500 TL"],
  ["DSİ ve Karayolları misafirhaneleri", "120 TL – 850 TL", "180 TL – 1.350 TL"],
  ["Diğer kamu misafirhaneleri (taban)", "120 TL ve üzeri", "180 TL ve üzeri"],
];
const cities = [
...
export default function Home() {
  ...
  return <main>
    <header className="site-header">
      <a className="brand header-brand" href="#ana-sayfa" aria-label="Kamu Sosyal Tesisleri ana sayfa"><img className="brand-logo" src="/kamu-sosyal-tesisleri-logo.png" alt="Kamu Sosyal Tesisleri logosu" width="164" height="164" /><span className="header-brand-name">Kamu Sosyal<br /><strong>Tesisleri</strong></span></a>
    ...
    <section className="prices-section" id="fiyatlar" aria-labelledby="prices-title"><div className="prices-heading"><div><p className="section-kicker">2026 rehberi</p><h2 id="prices-title">Konaklama fiyat listesi</h2></div><p>Fiyat aralıklarını kamu personeli ve sivil ziyaretçiler için karşılaştırın.</p></div><div className="price-table-wrap"><table><thead><tr><th scope="col">Tesis türü</th><th scope="col">Kamu personeli</th><th scope="col">Sivil</th></tr></thead><tbody>{priceList.map(([type, staff, civilian]) => <tr key={type}><th scope="row">{type}</th><td>{staff}</td><td>{civilian}</td></tr>)}</tbody></table></div><p className="prices-note">Fiyatlar 1 Ocak 2026 tarihli Resmî Gazete tebliği ve kurumların güncel listelerinden derlenmiştir. Tesisin konumu, yıldız sayısı ve oda özelliklerine göre fiyatlar değişebilir. Ağustos 2026 itibarıyla; rezervasyon öncesinde ilgili tesisten teyit edin.</p></section>
    ...
    <footer className="site-footer"><div className="footer-grid"><div className="footer-about"><a className="brand" href="#ana-sayfa"><span className="brand-mark" aria-hidden="true">K</span><span>Kamu Sosyal<br /><strong>Tesisleri</strong></span></a><p>Türkiye’nin 81 ilindeki öğretmenevi, misafirhane, orduevi, polisevi ve sosyal tesisleri tek platformda keşfedin; karşılaştırın ve konaklamanızı kolayca planlayın.</p><div className="social-links" aria-label="Sosyal medya hesaplarımız"><button type="button" aria-label="Instagram — yakında" title="Instagram yakında">◎</button><button type="button" aria-label="Facebook — yakında" title="Facebook yakında">f</button><button type="button" aria-label="Pinterest — yakında" title="Pinterest yakında">p</button><button className="tiktok-icon" type="button" aria-label="TikTok — yakında" title="TikTok yakında">♪</button></div></div><div><h3>Popüler şehirler</h3><a href="#tesisler" onClick={() => quickSearch("İstanbul")}>İstanbul</a><a href="#tesisler" onClick={() => quickSearch("Ankara")}>Ankara</a><a href="#tesisler" onClick={() => quickSearch("İzmir")}>İzmir</a><a href="#tesisler" onClick={() => quickSearch("Bursa")}>Bursa</a><a href="#tesisler" onClick={() => quickSearch("Antalya")}>Antalya</a><a href="#tesisler" onClick={() => quickSearch("Gaziantep")}>Gaziantep</a><a href="#ana-sayfa">Tüm şehirler →</a></div><div><h3>Kurum türleri</h3><a href="#tesisler" onClick={() => setCategory("Öğretmenevi")}>Öğretmenevleri</a><a href="#tesisler" onClick={() => setCategory("Orduevi")}>Orduevleri</a><a href="#tesisler" onClick={() => setCategory("Polisevi")}>Polisevleri</a><a href="#tesisler" onClick={() => setCategory("Misafirhane")}>Misafirhaneler</a><a href="#tesisler">Tüm kurumlar →</a></div><div><h3>Popüler aramalar</h3><a href="#fiyatlar">2026 konaklama fiyatları</a><a href="#tesisler" onClick={() => quickSearch("Öğretmenevi")}>Öğretmenevi fiyatları</a><a href="#tesisler" onClick={() => quickSearch("Antalya")}>Antalya kamu tesisleri</a><a href="#tesisler" onClick={() => quickSearch("İzmir")}>İzmir misafirhaneleri</a><a href="#fiyatlar">Kamu tesisi rehberi</a></div><div className="footer-contact"><h3>İletişim</h3><p>Rehberimizin doğruluğunu ve güncelliğini korumak en büyük önceliğimiz. Eksik, güncel olmayan veya kaldırılması gereken bir tesis bilgisi fark ederseniz lütfen bizimle paylaşın.</p></div></div><div className="footer-bottom"><small>© 2026 Kamu Sosyal Tesisleri · Türkiye’nin sosyal tesis rehberi · Resmî bir kamu kurumu sitesi değildir.</small><nav aria-label="Alt menü"><a href="#ana-sayfa">Hakkımızda</a><a href="#nasil-calisir">Kullanım şartları</a><a href="#guncel">Gizlilik politikası</a><a href="#fiyatlar">Fiyat rehberi</a></nav></div></footer>
    <style>{`.site-header .brand-logo{display:block;width:164px;height:164px;object-fit:contain;flex:0 0 auto}.site-header .header-brand{gap:15px}.site-header .header-brand-name{font-size:18px;line-height:1.08}.site-header .header-brand-name strong{display:block;margin-top:4px;font-size:27px}.site-footer .brand{display:block;width:90px;height:90px;background:url('/kamu-sosyal-tesisleri-logo.png') center/contain no-repeat}.site-footer .brand>*{display:none}@media(max-width:760px){.site-header .brand-logo{width:92px;height:92px}.site-header .header-brand{gap:8px}.site-header .header-brand-name{font-size:11px}.site-header .header-brand-name strong{margin-top:2px;font-size:16px}}`}</style>
  </main>;
}
