...
export default function Home() {
  ...
  return <main>
    <header className="site-header">
      <a className="brand" href="#ana-sayfa" aria-label="Kamu Sosyal Tesisleri ana sayfa"><img className="brand-logo" src="/kamu-sosyal-tesisleri-logo.png" alt="Kamu Sosyal Tesisleri logosu" width="82" height="82" style={{ width: 82, height: 82, objectFit: "contain" }} /></a>
    ...
    <style>{`.site-footer .brand{display:block;width:90px;height:90px;background:url('/kamu-sosyal-tesisleri-logo.png') center/contain no-repeat}.site-footer .brand>*{display:none}`}</style>
  </main>;
}
